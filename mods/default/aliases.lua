...
minetest.register_alias("fence_wood", "default:fence_wood")
minetest.register_alias("rail", "carts:rail")
minetest.register_alias("ladder_wood", "default:ladder_wood")
