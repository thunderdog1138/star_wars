...
mobs:register_mob("mobs_npc:human_male", {
	type = "npc",
	passive = false,
	damage = 3,
	...
	child_texture = human.male_skins,
...
mobs:register_mob("mobs_npc:human_female", {
	type = "npc",
	passive = false,
	damage = 3,
	attack_type = "dogfight",
	...
	mesh = "mobs_character.b3d",
	drawtype = "front",
	textures = human.female_skins,
	child_texture = human.female_skins,
	makes_footstep_sound = true,
	sounds = {},
	walk_velocity = 2,
	run_velocity = 3,
