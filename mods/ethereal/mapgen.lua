...
add_biome("clearing", nil, "ethereal:grove_dirt", 1, "default:dirt", 3,
...
add_biome("grassy", nil, "ethereal:grove_dirt", 1, "default:dirt", 3,
...
add_biome("jumble", nil, "ethereal:grove_dirt", 1, "default:dirt", 3,
...
add_biome("mushroom", nil, "ethereal:fungus_dirt", 1, "default:dirt", 3,
...
add_biome("volcanic", nil, "ethereal:charred_dirt", 1, "default:dirt", 3,
...
add_biome("swamp", nil, "ethereal:grove_dirt", 1, "default:dirt", 3,
...
-- wroshyr tree
add_schem({"ethereal:jungle_dirt", "default:dirt_with_rainforest_litter"}, 0.0025, {"junglee"}, 1, 100, ethereal.wroshyr_tree, ethereal.junglee)

-- brylark tree
add_schem({"ethereal:jungle_dirt", "default:dirt_with_rainforest_litter"}, 0.01, {"junglee"}, 1, 100, ethereal.brylark_tree, ethereal.junglee)

-- uneti tree
add_schem({"default:dirt_with_snow"}, 0.001, {"alpine"}, 120, 140, ethereal.uneti_tree, ethereal.alpine)
...
add_schem({"ethereal:cold_dirt", "default:dirt_with_coniferous_litter"}, 0.025, {"snowy"}, 10, 40, ethereal.pine_tree, ethereal.snowy)
add_schem({"default:dirt_with_snow"}, 0.025, {"alpine"}, 40, 140, ethereal.pine_tree, ethereal.alpine)

-- jogan tree
add_schem({"ethereal:grove_dirt"}, 0.02, {"jumble"}, 1, 100, ethereal.jogan_tree, ethereal.grassy)
add_schem({"ethereal:grove_dirt"}, 0.03, {"grassy"}, 1, 100, ethereal.jogan_tree, ethereal.grassy)
...
-- bamboo tree
add_schem({"ethereal:bamboo_dirt"}, 0.025, {"bamboo"}, 1, 100, ethereal.bamboo_tree, ethereal.bamboo)

-- bush
add_schem({"ethereal:bamboo_dirt"}, 0.08, {"bamboo"}, 1, 100, ethereal.bush, ethereal.bamboo)

-- vine tree
add_schem({"ethereal:grove_dirt"}, 0.02, {"swamp"}, 1, 100, ethereal.vine_tree, ethereal.swamp)
...
minetest.register_decoration({
	...
	flags = "force_placement",
	decoration = "default:water_source",
	spawn_by = {"ethereal:grove_dirt", "default:water_source"},
	num_spawn_by = 8,
})
end
...
minetest.register_decoration({
	deco_type = "schematic",
	place_on = {"ethereal:grove_dirt", "default:dirt_with_snow"},
	sidelen = 16,
	noise_params = {
		offset = -0.004,
		scale = 0.01,
...
minetest.register_decoration({
	deco_type = "schematic",
	place_on = {"ethereal:grove_dirt", "default:dry_dirt_with_dry_grass"},
	sidelen = 16,
	noise_params = {
		offset = -0.004,
		scale = 0.01,
...
-- flowers & strawberry
add_node({"ethereal:grove_dirt"}, 0.025, {"grassy"}, 1, 100, {"flowers:dandelion_white",
...
add_node({"ethereal:grove_dirt"}, 0.025, {"grassytwo"}, 1, 100, {"flowers:dandelion_white",
	"flowers:dandelion_yellow", "flowers:geranium", "flowers:rose", "flowers:tulip",
...
-- wild red mushroom
add_node({"ethereal:fungus_dirt"}, 0.01, {"mushroom"}, 1, 100, {"flowers:mushroom_fertile_red"}, nil, nil, nil, ethereal.mushroom)

local list = {
	{"junglee", {"ethereal:jungle_dirt", "default:dirt_with_rainforest_litter"}, ethereal.junglee},
	{"grassy", {"ethereal:grove_dirt"}, ethereal.grassy},
	{"grassytwo", {"ethereal:grove_dirt"}, ethereal.grassytwo},
	{"prairie", {"ethereal:prairie_dirt"}, ethereal.prairie},
	{"mushroom", {"ethereal:fungus_dirt"}, ethereal.mushroom},
	{"swamp", {"ethereal:grove_dirt"}, ethereal.swamp},
}
...
add_node({"ethereal:grove_dirt"}, 0.15, {"jumble"}, 1, 100, {"default:junglegrass"}, nil, nil, nil, ethereal.jumble)
add_node({"ethereal:grove_dirt"}, 0.25, {"swamp"}, 1, 100, {"default:junglegrass"}, nil, nil, nil, ethereal.swamp)

-- grass
add_node({"ethereal:grove_dirt"}, 0.35, {"grassy"}, 1, 100, {"default:grass_2", "default:grass_3",
	"default:grass_4", "default:grass_5"}, nil, nil, nil, ethereal.grassy)
add_node({"ethereal:grove_dirt"}, 0.35, {"grassytwo"}, 1, 100, {"default:grass_2", "default:grass_3",
	"default:grass_4", "default:grass_5"}, nil, nil, nil, ethereal.grassytwo)
add_node({"ethereal:grove_dirt"}, 0.35, {"jumble"}, 1, 100, {"default:grass_2", "default:grass_3",
...
add_node({"ethereal:grove_dirt"}, 0.35, {"clearing", "swamp"}, 1, 100, {"default:grass_3",
...
add_node({"ethereal:grove_dirt"}, 0.1, {"swamp"}, 1, 100, {"ethereal:fern"}, nil, nil, nil, ethereal.swamp)
...
-- wild onion
add_node({"ethereal:grove_dirt"}, 0.25, {"grassy"}, 1, 100, {"ethereal:onion_4"}, nil, nil, nil, ethereal.grassy)
add_node({"ethereal:grove_dirt"}, 0.25, {"grassytwo"}, 1, 100, {"ethereal:onion_4"}, nil, nil, nil, ethereal.grassytwo)
add_node({"ethereal:grove_dirt"}, 0.25, {"jumble"}, 1, 100, {"ethereal:onion_4"}, nil, nil, nil, ethereal.jumble)
add_node({"ethereal:prairie_dirt"}, 0.25, {"prairie"}, 1, 100, {"ethereal:onion_4"}, nil, nil, nil, ethereal.prairie)

-- papyrus
add_node({"ethereal:grove_dirt"}, 0.1, {"grassy"}, 1, 1, {"default:papyrus"}, 4, "default:water_source", 1, ethereal.grassy)
...
add_node({"ethereal:grove_dirt"}, 0.1, {"swamp"}, 1, 1, {"default:papyrus"}, 4, "default:water_source", 1, ethereal.swamp)
...
add_node({"ethereal:grove_dirt"}, 0.05, {"grassytwo"}, 1, 100, {"farming:carrot_7", "farming:cucumber_4",
...
add_node({"ethereal:grove_dirt"}, 0.05, {"grassy"}, 1, 100, {"farming:carrot_7", "farming:cucumber_4",
	"farming:potato_3", "farming:tomato_7", "farming:corn_8", "farming:coffee_5",
	"farming:raspberry_4", "farming:rhubarb_3", "farming:blueberry_4",
	"farming:beetroot_5"}, nil, nil, nil, ethereal.grassy)
add_node({"ethereal:grove_dirt"}, 0.05, {"jumble"}, 1, 100, {"farming:carrot_7", "farming:cucumber_4",
	"farming:potato_3", "farming:tomato_7", "farming:corn_8", "farming:coffee_5",
...
add_node({"ethereal:grove_dirt"}, 0.015, {"grassy"}, 1, 1, {"farming:melon_8", "farming:pumpkin_8"}, nil, "default:water_source", 1, ethereal.grassy)
add_node({"ethereal:grove_dirt"}, 0.015, {"grassytwo"}, 1, 1, {"farming:melon_8", "farming:pumpkin_8"}, nil, "default:water_source", 1, ethereal.grassytwo)
add_node({"ethereal:grove_dirt"}, 0.015, {"jumble"}, 1, 1, {"farming:melon_8", "farming:pumpkin_8"}, nil, "default:water_source", 1, ethereal.jumble)

-- green beans
add_node({"ethereal:grove_dirt"}, 0.035, {"grassytwo"}, 1, 100, {"farming:beanbush"}, nil, nil, nil, ethereal.grassytwo)

-- grape bushel
add_node({"ethereal:grove_dirt"}, 0.025, {"grassytwo"}, 1, 100, {"farming:grapebush"}, nil, nil, nil, ethereal.grassytwo)
add_node({"ethereal:grove_dirt"}, 0.025, {"grassy"}, 1, 100, {"farming:grapebush"}, nil, nil, nil, ethereal.grassy)
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"ethereal:grove_dirt", "default:sand"},
	sidelen = 16,
	noise_params = {
		offset = 0,
		scale = 0.009,
